...
public record ReservationResponse(
        ...
        Integer seatLockQuota,
        Integer seatLockUsedCount,
        LocalDateTime lockedUntilAt,
        String seatNo,
        String seatLabel,
        Long tableId,
        String tableNo,
    ...
    public static ReservationResponse from(Reservation reservation) {
        return new ReservationResponse(
                ...
                reservation.getSeatLockQuota(),
                reservation.getSeatLockUsedCount(),
                reservation.getLockedUntilAt(),
